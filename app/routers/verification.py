...
async def request_verification(verification: VerificationRequest):
    try:
        ...
        if response.status_code == 202:  # vonage success
            ...
            return JSONResponse(status_code=404, content={"Error from Vonage": response.json()})
...
async def check_code(data: CheckCodeRequest):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return JSONResponse(status_code=400, content={"Error from Vonage": response.json()})
